#!/bin/bash
# ============================================================================
# Run binary survival analysis for all TCGA datasets
# ============================================================================
...
TOTAL=${#CONFIG_FILES[@]}
print_header "Running Binary Survival Analysis for $TOTAL TCGA Datasets"
...
for i in "${!CONFIG_FILES[@]}"; do
    ...
    # Run binary analysis
    print_info "Running: pixi run binary -- --config $CONFIG"
